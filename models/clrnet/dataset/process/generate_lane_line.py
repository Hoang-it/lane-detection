...
class GenerateLaneLine(object):
    def __init__(self, transforms=None, cfg:dict=None, training=True):
        self.transforms = transforms
        self.img_w, self.img_h = cfg.get('img_w'), cfg.get('img_h')
        self.num_points = cfg.get('num_points')
        self.n_offsets = cfg.get('num_points')
        self.n_strips = cfg.get('num_points') - 1
        self.strip_size = self.img_h / self.n_strips
        self.max_lanes = cfg.get('max_lanes')
